function obj = calc_key_rates(bond,valuation_date,discount_curve)
  obj = bond;
   if ( nargin < 3)
	...
	for ii = 1:1:length(key_terms)
		...
		value_krs_down  = pricing_npv(valuation_date, cf_dates, ...
                                cf_values, bond.soy, ...
                                cf_dates, curve_keyrate_down, basis, ...
                                comp_type, comp_freq, interp_discount, ...
                                curve_comp_type, curve_basis, ...
                                curve_comp_freq,false);
		value_krs_up  = pricing_npv(valuation_date, cf_dates, ...
                                cf_values, bond.soy, ...
                                cf_dates, curve_keyrate_up, basis, ...
                                comp_type, comp_freq, interp_discount, ...
                                curve_comp_type, curve_basis, ...
                                curve_comp_freq,false);
