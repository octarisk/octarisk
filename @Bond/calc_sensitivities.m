...
if ( strcmp(bond.sub_type,'FRN') || strcmp(bond.sub_type,'SWAP_FLOAT'))
    ...
    % Get interpolation method
        interp_ref = reference_curve.get('method_interpolation');
    % Get Curve conventions
        comp_type_ref = reference_curve.get('compounding_type');
        comp_freq_ref = reference_curve.get('compounding_freq');              
        basis_ref     = reference_curve.get('basis');
    ...
    % downshock
        ...
        [ret_dates ret_values] = rollout_cashflows_oop(obj,nodes_ref, ...
                            rates_ref_sensi,valuation_date,interp_ref,...
                            comp_type_ref,basis_ref,comp_freq_ref);
