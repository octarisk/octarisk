   ...
   methods
      ...
      function obj = set.type(obj,type)
         typecell = { 'Discount Curve', 'Spread Curve', 'Dummy Curve', ...
                        ...
                        'Historical Curve', 'Inflation Expectation Curve', ...
                        'Mortality Table', 'Longevity Table','Shock Curve'};
         if ~(strcmpi(type,typecell))
            error('Type must be either Discount Curve, Spread Curve, Aggregated Curve, Dummy Curve, Call or Put Schedule, Inflation Expectation Curve, Hazard Curve, Historical Curve, Mortality Table, Longevity Table or Prepayment Curve')
         end
         obj.type = type;
      end % Set.type
