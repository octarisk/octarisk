    ...
    if ( tmp_dtm < 0 )
      ...
      % Valuation for: Black76 or Bachelier model according to type
        ...
        if (obj.use_underlyings == false)   % pricing with forward rates
            ...
            if ( regexpi(tmp_model,'black'))
                theo_value_base = swaption_black76(call_flag,tmp_forward_shock, ...
				...
				undvalue_down	= swaption_black76(call_flag,tmp_forward_shock * 0.99, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				undvalue_up	    = swaption_black76(call_flag,tmp_forward_shock * 1.01, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				rfrate_down     = swaption_black76(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv - 0.01, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				rfrate_up	    = swaption_black76(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv + 0.01, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);                    
				vola_down	    =  swaption_black76(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock * 0.99,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);                          
				vola_up	        = swaption_black76(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock * 1.01,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);   
				time_down	    = swaption_black76(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate - 1,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				time_up	        = swaption_black76(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate + 1,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);				
                ...
                theo_value_base = swaption_bachelier(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				% calculating effective greeks -> imply from derivatives
				undvalue_down	= swaption_bachelier(call_flag,tmp_forward_shock * 0.99, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				undvalue_up	    = swaption_bachelier(call_flag,tmp_forward_shock * 1.01, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				rfrate_down     = swaption_bachelier(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv - 0.01, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				rfrate_up	    = swaption_bachelier(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv + 0.01, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);                    
				vola_down	    =  swaption_bachelier(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock * 0.99,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);                          
				vola_up	        = swaption_bachelier(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock * 0.01,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);   
				time_down	    = swaption_bachelier(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate - 1,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				time_up	        = swaption_bachelier(call_flag,tmp_forward_shock, ...
                                        tmp_strike,tmp_effdate + 1,tmp_rf_rate_conv, ...
                                        tmp_imp_vola_shock,tmp_swap_no_pmt, ...
                                        tmp_swap_tenor);
				dVola = 0.01;
            ...
            theo_value_base = swaption_underlyings(call_flag,tmp_strike,V_fix, ...
                               V_float,tmp_effdate,tmp_imp_vola_shock, ...
                               tmp_model);
			% calculating effective greeks -> imply from derivatives
			% calculate shock to Y_u:
			dY_u = 0.01 * tmp_strike .* V_float ./ V_fix;
			undvalue_down	= swaption_underlyings(call_flag,tmp_strike,V_fix, ...
                               V_float * 0.99,tmp_effdate,tmp_imp_vola_shock, ...
                               tmp_model);	% shock underlying floating leg
			undvalue_up	    = swaption_underlyings(call_flag,tmp_strike,V_fix, ...
                               V_float * 1.01,tmp_effdate,tmp_imp_vola_shock, ...
                               tmp_model);  % shock underlying floating leg
							   
			rfrate_down     = swaption_underlyings(call_flag,tmp_strike,V_fix, ...
                               V_float,tmp_effdate,tmp_imp_vola_shock, ...
                               tmp_model); % no shock applied -> sensi rho = 0.0
			rfrate_up	    = swaption_underlyings(call_flag,tmp_strike,V_fix, ...
                               V_float,tmp_effdate,tmp_imp_vola_shock, ...
                               tmp_model); % no shock applied -> sensi rho = 0.0 
							   
			vola_down	    =  swaption_underlyings(call_flag,tmp_strike,V_fix, ...
                               V_float,tmp_effdate,tmp_imp_vola_shock - 0.01, ...
                               tmp_model);                       
			vola_up	        = swaption_underlyings(call_flag,tmp_strike,V_fix, ...
                               V_float,tmp_effdate,tmp_imp_vola_shock + 0.01, ...
                               tmp_model); 
							   
			time_down	    = swaption_underlyings(call_flag,tmp_strike,V_fix, ...
