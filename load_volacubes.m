...
%# -*- texinfo -*-
%# @deftypefn {Function File} {[@var{surface_struct} @var{vola_failed_cell}] =} 
%# load_volacubes(@var{surface_struct}, @var{path_mktdata}, 
%# @var{input_filename_vola_index}, @var{input_filename_vola_ir})
...
tmp_surface_object = Surface('RF_VOLA_INDEX_DUMMY','RF_VOLA_INDEX_DUMMY', ...
                                'INDEX','Dummy Vola Surface');
...
tmp_surface_object = Surface('RF_VOLA_IR_DUMMY','RF_VOLA_IR_DUMMY','IR', ...
                            'Dummy Vola Surface');
