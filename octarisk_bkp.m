...
elseif ( strcmpi(tmp_scen_set,'stress') )     % Stress scenario
	port_obj_tmp = port_obj_tmp.aggregate(tmp_scen_set, instrument_struct, index_struct, para_object);
    port_obj_tmp = port_obj_tmp.calc_risk(tmp_scen_set, instrument_struct, index_struct, para_object);
    %port_obj_tmp = port_obj_tmp.print_report(para_object,'stress',tmp_scen_set,stresstest_struct);				
	port_obj_tmp = port_obj_tmp.plot(para_object,'stress',tmp_scen_set,stresstest_struct);					 
	port_obj_tmp
