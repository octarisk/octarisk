...
%# -*- texinfo -*-
%# @deftypefn {Function File} {@var{retcode} =} plot_corr_matrix (@var{input_heatmap}, @var{identifier}, @var{path_reports}, @var{filename}, @var{title_string}, @var{x_axis_label}, @var{y_axis_label}, @var{xlabels}, @var{ylabels})
%# Generic correlation matrix plot for any given n x n matrix.
%#
%# @seealso{}
%# @end deftypefn


function retcode = plot_corr_matrix(plotmat,identifier,path_reports,filename,title_string,x_axis_label,y_axis_label,xlabels,ylabels)

retcode = 1;
if nargin != 9
	fprintf('plot_corr_matrix: number of arguments not 9\n');
	retcode = 0
end
...
set(gca,'XTick',1:numlabels,...
    ...
    'YTick',1:numlabels,...
    'YTickLabel',ylabels,...
    'xticklabelrotation',0,... % currently unused as of Octave 8.4.0
    'TickLength',[0 0]);
...
% save plotting
	...
	print (hf,filename_plot_stylebox, "-dpng", "-S1700,800");
	filename_plot_stylebox = strcat(path_reports,'/',identifier,'_',filename,'.pdf');
	print (hf,filename_plot_stylebox, "-dpdf", "-S1700,800");
	filename_plot_stylebox = strcat(path_reports,'/',identifier,'_',filename,'.svg');
	print (hf,filename_plot_stylebox, "-dsvg", "-S1700,800");
