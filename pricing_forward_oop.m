...
%# -*- texinfo -*-
%# @deftypefn {Function File} {[@var{theo_value} ] =} pricing_forward_oop (@var{forward}, @var{discount_nodes}, @var{discount_rates}, @var{curve_comp_type}, @var{curve_basis}, @var{curve_comp_freq})
%#
...
function [theo_value theo_price] = pricing_forward_oop(forward,discount_nodes, ...
                                discount_rates, underlying_price,...
