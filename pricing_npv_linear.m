...
function [npv MacDur Convexity MonDur Convexity_alt] = pricing_npv_linear(valuation_date, ...
...
%!assert(pricing_npv_linear(datenum('31-Dec-2015'),[182,547,912],[3,3,103],0.005,[90,365,730,1095],[0.01,0.02,0.025,0.028;0.005,0.015,0.019,0.024;-0.04,0.03,-0.02,0.05],11,'cont','annual','monotone-convex'),[101.014302298068;102.259330913865;104.657072744736],0.000002)
%!assert(pricing_npv_linear(datenum('31-Dec-2015'),[182,547,912],[3,3,103],0.005,[90,365,730,1095],[0.01,0.02,0.025,0.028],3,'discrete','annual','linear'),101.171107422211,0.000001)
%!assert(pricing_npv_linear(datenum('31-Dec-2015'),[182,547,912],[3,3,103],0.005,[90,365,730,1095],[0.01,0.02,0.025,0.028],3,'discrete','annual','monotone-convex'),101.133566977140,0.000001)
%!assert(pricing_npv_linear(datenum('31-Dec-2015'),[314,679,1044,1409,1775,2140,2505,2870,3236,3601,3966],[1.504109589,1.5,1.5,1.5,1.504109589,1.5,1.5,1.5,1.504109589,1.5,101.5], 0.0,[314],[0.01],3, 'simple', 'annual', 'linear', 'simple', 3, 'annual'),105.811112622,0.00000001)            
%!assert(pricing_npv_linear(datenum('31-Dec-2015'),[314,679,1044,1409,1775,2140,2505,2870,3236,3601,3966],[1.504109589,1.5,1.5,1.5,1.504109589,1.5,1.5,1.5,1.504109589,1.5,101.5], 0.0,[314],[0.01],3, 'simple', 'annual', 'linear', 'cont', 3, 'annual'),105.283752847214,0.00000001)            
%!assert(pricing_npv_linear(datenum('31-Dec-2015'),[314,679,1044,1409,1775,2140,2505,2870,3236,3601,3966],[1.504109589,1.5,1.5,1.5,1.504109589,1.5,1.5,1.5,1.504109589,1.5,101.5], 0.0,[314],[0.01],3, 'simple', 'annual', 'linear', 'cont', 0, 'annual'),105.291914185406,0.00000001)            
%!assert(pricing_npv_linear(datenum('31-Dec-2015'),[314,679,1044,1409,1775,2140,2505,2870,3236,3601,3966],[1.504109589,1.5,1.5,1.5,1.504109589,1.5,1.5,1.5,1.504109589,1.5,101.5], 0.0,[314],[0.01],3, 'simple', 'annual', 'linear', 'disc', 0, 'annual'),105.344763058056,0.00000001)            

%!test
%! [npv MacDur Convexity]=pricing_npv_linear(datenum('31-Dec-2015'),[314,679,1044,1409,1775,2140,2505,2870,3236,3601,3966],[1.504109589,1.5,1.5,1.5,1.504109589,1.5,1.5,1.5,1.504109589,1.5,101.5], 0.0,[365,3650],[0.01,0.02],3, 'simple', 'annual', 'linear', 'disc', 0, 'annual', true);
...
%!test
%! [npv MacDur Convexity] = pricing_npv_linear(datenum('31-Dec-2015'),[314,679,1044,1409,1775,2140,2505,2870,3236,3601,3966],[1.504109589,1.5,1.5,1.5,1.504109589,1.5,1.5,1.5,1.504109589,1.5,101.5], 0.0,[30,91,365,730,1095,1460,1825,2190,2555,2920,3285,3650,4015],[0.00010026,0.00010027,0.00010027,0.00010014,0.00010009,0.00096236,0.00231387,0.00376975,0.005217,0.00660956,0.00791501,0.00910955,0.01018287],3, 'simple', 'annual', 'linear', 'cont', 3, 'annual', true);
