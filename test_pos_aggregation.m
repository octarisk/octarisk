...
[instrument_struct, curve_struct, index_struct, surface_struct, para_object, matrix_struct, riskfactor_struct, ...
portfolio_struct, stresstest_struct, mc_var_shock_pct, port_obj_struct] = octarisk('C:/Dokumente/Work/octarisk/sii_stdmodel_folder');
...
portobj = portobj.calc_risk('stress',para_object);
portobj
