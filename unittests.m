...
function_cell= {'pricing_npv','option_bs','option_willowtree', ...
                ...
                'calibrate_yield_to_maturity', 'get_sub_object', 'get_basis', ...
                'calibrate_option_barrier', 'any2str', 'struct2obj', ...
                'rollout_structured_cashflows', 'calcVolaShock' , ...
                'getCapFloorRate', 'calcConvexityAdjustment', ...
                'generate_willowtree','return_checked_input', ...
                'option_asian_vorst90','calibrate_option_asian_vorst90', ...
                'option_asian_levy','calibrate_option_asian_levy'};
